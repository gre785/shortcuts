        ...
        $scope.shortcutTables = [
          {
            "shortcuts": [
                ...
                {"description": "Reopen Closed Editor Tab", "eclipse": "Ctrl + Shift + T", "vscode": "Ctrl + Shift + T", "intellij": "Ctrl + Shift + T", "visualstudio": "Ctrl + K, Ctrl + Z", "qt": "No Default"},
                ...
                {"description": "Add Multi-Cursor Above", "eclipse": "Alt + Shift + A (Block Mode)", "vscode": "Ctrl + Alt + Up", "intellij": "Alt + Shift + Up", "visualstudio": "Ctrl + Alt + Up", "qt": "No Default"},
                {"description": "Add Multi-Cursor Below", "eclipse": "Alt + Shift + A (Block Mode)", "vscode": "Ctrl + Alt + Down", "intellij": "Alt + Shift + Down", "visualstudio": "Ctrl + Alt + Down", "qt": "No Default"},
                {"description": "Add Selection to Next Find Match", "eclipse": "No Default", "vscode": "Ctrl + D", "intellij": "Alt + J", "visualstudio": "Shift + Alt + .", "qt": "No Default"},
                {"description": "Select All Occurrences of Current Symbol", "eclipse": "Alt + Shift + U", "vscode": "Ctrl + Shift + L", "intellij": "Ctrl + Alt + Shift + J", "visualstudio": "Shift + Alt + ;", "qt": "No Default"},
